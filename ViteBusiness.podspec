...
Pod::Spec.new do |s|
  s.name             = 'ViteBusiness'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ViteBusiness.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/haoshenyang/ViteBusiness'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'haoshenyang' => 'shenyang@vite.org' }
  s.source           = { :git => 'https://github.com/haoshenyang/ViteBusiness.git', :tag => s.version.to_s }
