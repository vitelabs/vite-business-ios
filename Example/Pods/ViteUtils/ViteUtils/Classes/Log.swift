...
public func plog(level: XCGLogger.Level, log: @escaping @autoclosure () -> Any?, tags: [Tag] = [], functionName: StaticString = #function, fileName: StaticString = #file, lineNumber: Int = #line) {
