...
public struct R: Rswift.Validatable {
  ...
  public struct string {
    /// This `R.string.localizable` struct is generated, and contains static references to 1007 localization keys.
    public struct localizable {
      ...
      /// en translation: 借币成功后需手动操作使用借款，请预留操作时间。例如获取配额需抵押至少约3天时间，借币期限至少4天才可能满足抵押获取配额。另外，预留时间需考虑节点丢块造成的时间和快照块之间的误差。
      /// 
      /// Locales: en, zh-Hans
