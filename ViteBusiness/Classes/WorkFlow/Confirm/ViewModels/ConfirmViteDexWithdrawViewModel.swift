...
struct ConfirmViteDexWithdrawViewModel: ConfirmViewModelType {
    ...
    var confirmTitle: String {
        return R.string.localizable.confirmTransactionPageViteDexWithdrawTransferTitle()
    }
    var biometryConfirmButtonTitle: String {
        return R.string.localizable.confirmTransactionPageViteDexWithdrawConfirmButton()
    }
