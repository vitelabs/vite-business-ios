...
struct ConfirmViteDexSellViewModel: ConfirmViewModelType {
    ...
    var confirmTitle: String {
        return R.string.localizable.confirmTransactionPageViteDexSellTitle(self.tokenInfo.toViteToken()!.uniqueSymbol)
    }
    var biometryConfirmButtonTitle: String {
        return R.string.localizable.confirmTransactionPageViteDexSellConfirmButton()
    }
