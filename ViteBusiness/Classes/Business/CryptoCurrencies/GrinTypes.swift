...
public struct GRINWalletInfo: Mappable {
    ...
    public mutating func mapping(map: Map) {
        lastConfirmedHeight <- (map["last_confirmed_height"], GRINJSONTransformer.int)
        minimumConfirmations <- (map["minimum_confirmations"], GRINJSONTransformer.int)
        total <- (map["total"], GRINJSONTransformer.int)
        amountAwaitingConfirmation <- (map["amount_awaiting_confirmation"], GRINJSONTransformer.int)
        amountAwaitingFinalization <- (map["amount_awaiting_finalization"], GRINJSONTransformer.int)
        amountImmature <- (map["amount_immature"], GRINJSONTransformer.int)
        amountCurrentlySpendable <- (map["amount_currently_spendable"], GRINJSONTransformer.int)
        amountLocked <- (map["amount_locked"], GRINJSONTransformer.int)
    }
}
...
public struct TxLogEntry: Mappable {
    ...
    public mutating func mapping(map: Map) {
        ...
        amountCredited <- (map["amount_credited"], GRINJSONTransformer.int)
        amountDebited <- (map["amount_debited"], GRINJSONTransformer.int)
        fee <- (map["fee"], GRINJSONTransformer.int)
...
public struct Slate: Mappable {
    ...
    public mutating func mapping(map: Map) {
        ...
        id <- map["id"]
        tx <- map["tx"]
        amount <- (map["amount"] ,GRINJSONTransformer.int)
        fee <- (map["fee"] ,GRINJSONTransformer.int)
        height <- (map["height"] ,GRINJSONTransformer.int)
        lockHeight <- (map["lock_height"] ,GRINJSONTransformer.int)
        ttl_cutoff_height <- (map["ttl_cutoff_height"],GRINJSONTransformer.int)
...
public struct OutputData: Mappable {
    ...
    public mutating func mapping(map: Map) {
        ...
        value <- (map["value"], GRINJSONTransformer.int)
        status <- map["status"]
        height <- (map["height"], GRINJSONTransformer.int)
        lock_height <- (map["lock_height"], GRINJSONTransformer.int)
...
public struct GRINJSONTransformer {
