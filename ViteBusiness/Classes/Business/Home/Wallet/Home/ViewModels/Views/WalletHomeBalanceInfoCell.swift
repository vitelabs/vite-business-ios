...
class WalletHomeGrinBalanceInfoCell: WalletHomeBalanceInfoCell {
...
//        label.text = (R.string.localizable.grinInitingDesc())
//        return label
//    }()
...
//
//        alertLabel.snp.makeConstraints { (m) in
//            m.top.equalToSuperview()
//            m.bottom.equalToSuperview().offset(-20)
//            m.left.equalToSuperview().offset(180)
//            m.right.equalToSuperview().offset(-26)
//        }
        
        GrinManager.default.walletCreated.asObservable().bind { [weak self] created in
            if created {
                self?.balanceLabel.text = ""
            } else {
                self?.balanceLabel.text = R.string.localizable.grinInitingDesc()
            }
    ...
    override func bind(viewModel: WalletHomeBalanceInfoViewModel) {
        ...
        if !GrinManager.default.walletCreated.value {
            ...
            balanceLabel.text = R.string.localizable.grinInitingDesc()
            priceLabel.text = ""
